package fr.nocsy.mcpets.bukkit;

import com.google.common.collect.Lists;
import com.sk89q.worldguard.WorldGuard;
import fr.nocsy.mcpets.bukkit.commands.CommandHandler;
import fr.nocsy.mcpets.bukkit.compat.PlaceholderAPICompat;
import fr.nocsy.mcpets.bukkit.data.Pet;
import fr.nocsy.mcpets.bukkit.data.PetSkin;
import fr.nocsy.mcpets.bukkit.data.config.*;
import me.tooobiiii.mcpets.bukkit.data.config.*;
import fr.nocsy.mcpets.bukkit.data.editor.EditorConversation;
import fr.nocsy.mcpets.bukkit.data.editor.EditorItems;
import fr.nocsy.mcpets.bukkit.data.flags.FlagsManager;
import fr.nocsy.mcpets.bukkit.data.livingpets.PetStats;
import fr.nocsy.mcpets.bukkit.data.sql.Databases;
import fr.nocsy.mcpets.bukkit.data.sql.PlayerData;
import fr.nocsy.mcpets.bukkit.listeners.EventListener;
import fr.nocsy.mcpets.bukkit.modeler.AbstractModeler;
import fr.nocsy.mcpets.bukkit.modeler.ModelEngineModeler;
import fr.nocsy.mcpets.bukkit.velocity.VelocitySyncManager;
...
import static fr.nocsy.mcpets.bukkit.mythicmobs.MythicListener.*;
