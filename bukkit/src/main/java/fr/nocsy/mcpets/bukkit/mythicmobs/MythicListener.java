package fr.nocsy.mcpets.bukkit.mythicmobs;
...
public class MythicListener implements Listener {
    ...
    public static final String PLACEHOLDER_PACKAGE = "fr.nocsy.mcpets.bukkit.mythicmobs.placeholders";
    public static final String CONDITION_PACKAGE = "fr.nocsy.mcpets.bukkit.mythicmobs.conditions";
    public static final String TARGETER_PACKAGE = "fr.nocsy.mcpets.bukkit.mythicmobs.targeters";
    public static final String MECHANIC_PACKAGE = "fr.nocsy.mcpets.bukkit.mythicmobs.mechanics";
