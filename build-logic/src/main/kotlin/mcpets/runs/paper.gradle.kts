...
import gradle.kotlin.dsl.accessors._18294152553871b7c5891a3876490b87.runPaper
import mcpets.build.PaperRunDefaults
import mcpets.build.PaperRunSpec
import mcpets.build.PaperRunsExtension
